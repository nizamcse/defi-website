...
import {AiOutlineLayout,AiOutlineFieldTime,AiOutlineQrcode, AiOutlineUser} from "react-icons/ai"
...
function WalletNav(props) {
  ...
  const NavButtons=[
    ...
    {name:t("LoginInfo"),icon:<AiOutlineUser size={30} className="inline"/>},
  ];
